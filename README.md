<p align="left">Olá! Sou Fernando, desenvolvedor Python sênior. Trabalho criando soluções que automatizam processos, estruturam dados e entregam resultados claros para empresas de diferentes setores.  
